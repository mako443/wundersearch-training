...
# python3 -m training.vse --epochs 8 --batch_size 64 --embed_dim 1024 --margin 0.25 --resize_image 250 --lr_gamma 0.85 --bi_dir
# python3 -m training.vse --epochs 8 --batch_size 64 --embed_dim 1024 --margin 0.35 --resize_image 250 --lr_gamma 0.85 --bi_dir
# python3 -m training.vse --epochs 8 --batch_size 64 --embed_dim 1024 --margin 0.35 --resize_image 250 --lr_gamma 0.85 --bi_dir --num_lstm 2

# python3 -m training.vse --epochs 16 --batch_size 64 --embed_dim 1024 --margin 0.25 --resize_image 250 --lr_gamma 0.85 --bi_dir
# python3 -m training.vse --epochs 16 --batch_size 64 --embed_dim 1024 --margin 0.25 --resize_image 250 --lr_gamma 0.85 --bi_dir --num_lstm 2

# python3 -m training.vse --epochs 32 --batch_size 64 --embed_dim 1024 --margin 0.25 --resize_image 250 --lr_gamma 0.85 --bi_dir

python3 -m training.vse --epochs 8 --batch_size 64 --embed_dim 300  --margin 0.25 --resize_image 250 --lr_gamma 0.85 --bi_dir --use_glove
python3 -m training.vse --epochs 8 --batch_size 64 --embed_dim 1024 --margin 0.25 --resize_image 250 --lr_gamma 0.85 --bi_dir --use_glove


# WEITER: GLoVE, reduce words, MS COCO + mix, stronger image model (check runtime), HRL continue (lr 0.000032 and 1x below)